...
public class NetworkUtils {
    ...
    public static boolean isConnectInternet(final Context pContext) {
        ...
        @SuppressLint("MissingPermission") final NetworkInfo networkInfo = conManager.getActiveNetworkInfo();
    ...
    public static boolean isConnectWifi(final Context pContext) {
        ...
        @SuppressLint("MissingPermission") NetworkInfo info = mConnectivity.getActiveNetworkInfo();
